export const data = [
    {
        ...
        "Event": {
                "title": "LGBT+ Dog Walk",
                "location": "Meanwood Park",
                "time": "Sat November 13th: 9am",
                "description": "LGBT+ inclusive dog walk",
                "link": "https://www.eventbrite.co.uk/e/leeds-lgbt-dog-walk-at-meanwood-park-tickets-148343698997?aff=ebdssbdestsearch"
        },
        "Podcast": {
                "title": "Getting Curious",
                "host": "Jonathan Van Ness",
                "description": "JVN is inquisitive about a lot of things: cults, Lizzo, bees, the war in Yemen, the Romanovs, cash bail, artificial intelligence, the Beyoncé of renaissance painting, Brazil, menstrual cups, and figure skating, to name a few. Every week, the lusciously bearded Queer Eye guru sits down with a different specialist (from historians to surgeons and musicians) to spill tea and get answers to burning questions."
        },
        "Book": {
    ...
    {
        "Story":  { 
                "text": "Er la um bummelte herunter fraulein befehlen begehrte hindurch mu. Mitkommen schneider gewachsen zu spurenden wo magdebett sa. Esse denn dann ganz die auf trug steh sah. Ja im spurenden sorglosen argerlich zu. An begierig es streckte um sparlich pa konntest ansprach madchens. Buch mirs pa mu ture auch ware lieb da. Halt ihre mann den aber sag tief sehe dem. Einen weich blick hin die kunde mit habet. Kann da mein um leid.",
                "author": "Greta"
            },
        "Event": {
                "title": "Drag n Bass",
                "location": "Wharf Chambers, Leeds",
                "time": "Sat Nov 27th at 12:00am-04:00.",
                "description": "An LGBT+ inclusive DnB Night",
                "link": "https://allevents.in/leeds/drag-n-bass/300035854079"
        },
        "Podcast": {
                "title": "Good 4 Thot",
                "host": "Tommy Pico, Fran Tirado, Dennis Norris II, and Joe Osmundson",
                "description": "A buoyant and brash deep dive into all things L, G, B, T, and Q (underwear parties to identity politics, theorist José Esteban Muñoz to 90s R&B) curated by a deliciously queer roundtable of multifaceted, multiracial movers and shakers. Winky recurring segments include 'Swipe Left, Swipe Right' (takes on cultural flashpoints, both highbrow and lowbrow) and 'Impure Thots' (cheeky remembrances of hot and/or bothered hook-ups). So grab a glass of rosé and get ready to dish."
        },
        "Book": {
                "title": "Rubyfruit Jungle: A Novel",
                "author": "RITA MAE BROWN",
                "description": "Molly Bolt is the adoptive daughter of a poor Southern couple who makes her own way across America, finding love of all stripes in between.. It's a true, slightly steamy celebration of being true to yourself, whoever that may be"
        },
        "Music": {
                "title": "Vogue",
                "artist": "Madonna",
