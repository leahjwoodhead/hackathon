    ...
    return (
        <div className="AboutPage">
            ...
            <div className="AboutContent">
                ...
                <h4>The idea behind the platform is very simple: each day we will be sharing a story of LGBTQ+ community members together with their favourite movies, songs, books & podcasts. Get inspired!</h4>
            </div>
        </div>
    );
}
